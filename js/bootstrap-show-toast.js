...
;(function (bootstrap) {
    ...
    function Toast(props) {
        ...
        this.props = {
            ...
            colorHeader: "", // the color of the header text
            ...
            delay: 3000, //	delay in milliseconds before hiding the toast, set delay to `Infinity` to make it sticky
            position: "top-0 end-0", // top right
            direction: "append", // or "prepend", the stack direction
            zIndex: 999999999999999999999999, // the z-index of the container
            ariaLive: "assertive"
        }
        ...
        if (showHeader) {
            toastHeader = `<div class="toast-header text-white" style="background-color: hsla(0, 100%, 90%, 0.3);">
                            <strong class="me-auto ${this.props.colorHeader ? this.props.colorHeader : 'text-white'}">${this.props.header}</strong>
